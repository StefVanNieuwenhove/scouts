...
/* auth, */ (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const decode = req.query.decrypt === 'true' ? true : false;
        ...
        if (decode) {
            members.forEach((member) => {
                if (member.national_number) {
                    const decrypted = (0, middleware_1.decrypt)(member.national_number, member.iv, member.secret_key);
...
/* auth, */ (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const roles = Object.values(client_1.Lid_tak);
...
/* auth, */ (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const { data, iv, secret_key } = (0, middleware_1.encrypt)(req.body.national_number);
        console.log({ data, iv });
        if (!data) {
            return res.status(500).json('Failed to encrypt national number');
        }
        const member = yield prisma.members.create({
            data: Object.assign(Object.assign({}, req.body), { date_of_birth: new Date(req.body.date_of_birth), national_number: data, secret_key: secret_key, iv: iv }),
        });
        res.status(200).json(member);
    }
    catch (error) {
